...
AddRooms(){
    ...
    JLabel type = new JLabel("Add Type");
...
public void actionPerformed(ActionEvent ae){
         ...
         if(ae.getSource() == b1 ){
             try{
             int ad = Integer.parseInt(t2.getText());
        ...
        conn c = new conn();
         ...
         String str6 = "select * from room ";
            ResultSet rs = c.s.executeQuery(str6);
            while(rs.next()){
                String room1 = rs.getString("room_number");
         ...
         try{
             ...
             System.out.println(e);
                 ...
                 JOptionPane.showMessageDialog(null, "Room Is Already Present");
                     }
         }catch(Exception e){
