    ...
    public void actionPerformed(ActionEvent ae){
         ...
         if(ae.getSource() == b1){
             try{
                ...
                long pho = Integer.parseInt(t4.getText());
                long adh = Integer.parseInt(t5.getText());
        ...
        String gender =null;
         ...
         try{
             ...
             System.out.println(e);
                 ...
                 JOptionPane.showMessageDialog(null, "Not a correct format for email");
             }
             }catch(Exception e){
                JOptionPane.showMessageDialog(null, "Not A Correct Form Of Input");
          }
